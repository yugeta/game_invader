(function(w,d){
  ...
  var __options = {
    ...
    invader_effect_1 : {
      color : "white",
      src   : "//wordpress.ideacompo.com/wp-content/uploads/invader/invader_effect_1.dot",
      x : 0 , y : 0,
    },

    tochika : {
      color : "red",
      src   : "//wordpress.ideacompo.com/wp-content/uploads/invader/tochika.dot",
      w     : 72,
      rate  : 2.5
    },
    ...
    bullet_anim : [
      "//wordpress.ideacompo.com/wp-content/uploads/invader/bullet_1.dot",
      "//wordpress.ideacompo.com/wp-content/uploads/invader/bullet_2.dot"
    ],
    del_block : [
      "01110",
      "01010",
    ...
    sounds : {
      "shoot" : {
        mode : "se",
        src  : "//wordpress.ideacompo.com/wp-content/uploads/invader/shoot.mp3"
      },
      "bgm"   : {
        mode : "loop",
        src  : "//wordpress.ideacompo.com/wp-content/uploads/invader/bgm.mp3"
      }
    }
  };
...
// console.log(tx+"/"+ty+":"+tw+"/"+th);
  ...
  MAIN.prototype.bgm_loop = function(){
    if(this.audio.bgm.currentTime + 0.100 < this.audio.bgm.duration){return;}
    this.audio.bgm.currentTime = 0;
  };
